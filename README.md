...
- **UX Design:**
  ...
  - The page background changes to indicate the win or loss of a game.
...
- **JavaScript:**
  - Made clean modular functions such that if they don't need to know about the DOM, then they don't.
